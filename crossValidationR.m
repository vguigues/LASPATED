...
function [weight,x]=crossValidationReg(sample,
indexBeta,x,C,D,T,R,regressor,nbLandTypes,proportion,betaBar,sizex,iterMax,sigma,epsilon,nbObs,isHolidays,obsbefore)

weights=[0.1,1,10,100,1000,10^4];
maxLikelihood=inf;
                ...
                for d=1:D
                    for t=1:T
                        for i=1:R
                            ...
                            nbCallsRemaining(c,day,t,i)=nbCallsRemaining(c,day,t,i)+samples{c,day,t,i}(obsbefore(index));      
                        end
                    end
                end
            end
        ...
        for d=1:D
            for i=1:R
                for c=1:C
                    ...
                    nbCalls(c,day,t,i)=nbCalls(c,day,t,i)+samples{c,day,t,i}(obsbefore(index));      
                end
            end
        end
    end
