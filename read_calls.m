...
function [T,G,R,P,nbLandTypes,nbObservationsG,sample_calls,nbCalls,nbObservations,estimated,type,regressors,neighbors,distance]=read_calls(discretization_dir)
%function [T,G,R,P,nbLandTypes,nbObservationsG,nbCalls,estimated,type,regressors,neighbors,distance]=read_calls(discretization_dir)
