...
public:
  ...
  GeneratorNoRegressor(std::string calls_path, std::string neighbors_path,
                       std::string info_path);
  GeneratorNoRegressor(xt::xarray<int> &N, xt::xarray<int> &M,
  ...
  // x_beta, 	xt::xarray<double>& x_delta, double alpha, double sigma, double
  // beta_bar);
  ...
  double get_lower_bound(xt::xarray<double> &x_current,
                         xt::xarray<double> &grad_current, double eps,
                         double upper_lambda);
