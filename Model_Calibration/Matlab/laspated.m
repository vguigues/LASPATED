...
elseif (strcmp(model,'reg'))
    ...
    [lambda,obj]=projectedGradientArmijoFeasible2(nbObservations,nbArrivals,lambda0,C,params.D,T,R,weight,params.regressor,params.nbRegressors,iterMax,sigma,epsilon,params.indexBeta,Groups,durations,params.sizex,whichgroup);
else
