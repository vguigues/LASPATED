...
elseif (strcmp(model,'reg'))
    ...
    [cputime,weight,lambda]=crossValidationReg(sample,params.indexBeta,x,P,params.D,T,R,params.regressor,params.nbRegressors,proportion,params.sizex,iterMax,sigma,epsilon,params.nbObs,params.isHolidays,params.obsbefore,Groups,durations,whichgroup,weights);
else
